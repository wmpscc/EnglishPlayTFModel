...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermissionHelper.with(CameraActivity.this).permissions(Manifest.permission.CAMERA).requestCode(100).lisener(CameraActivity.this).request();
        //设置无标题
        ...
        public void onPictureTaken(final byte[] data, Camera camera) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent = new Intent(CameraActivity.this, TranslateActivity.class);
